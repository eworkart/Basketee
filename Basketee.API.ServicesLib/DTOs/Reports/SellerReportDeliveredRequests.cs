...
namespace Basketee.API.DTOs.Reports
{
    ...
    public class AgentBossReportSellerDeliveredRequest : AuthBase {
        /// <summary>
        /// 1 - Month
        /// 2 - Week
        /// </summary>
    ...
    public class SuperUserReportSellerDeliveredRequest : AuthBase
    {
        /// <summary>
        /// 1 - Month
        /// 2 - Week
    ...
    public class SellerReportDeliveredRequest
    {
